...
<?php echo $this->Form->create('WorkFlowDetailComment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Work Flow Detail Comment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('WorkFlowDetailComment.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('WorkFlowDetailComment.id')))); ?></li>
