...
<?php echo $this->Form->create('WorkFlowHead'); ?>
	<fieldset>
		<legend><?php echo __('Edit Work Flow Head'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('WorkFlowHead.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('WorkFlowHead.id')))); ?></li>
